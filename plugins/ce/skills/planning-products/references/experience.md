...
The output here feeds into `Skill(design)` for visual implementation and Claude's plan mode for technical implementation.
...
Hand off to `Skill(design)` for visual implementation. Use Claude's plan mode for technical task breakdown.
